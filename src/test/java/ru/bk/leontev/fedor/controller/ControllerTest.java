...
import ru.bk.leontev.fedor.models.*;
...
public class ControllerTest {
    ...
    public void testSave() throws Exception {
        ...
        Entity user = new User("tester", "password");
    ...
    public void listOnQuery() throws Exception {
        ...
        Controller controller = new Controller();
        //выбираем
        LinkedList<Entity> listResult = controller.listOnQuery("SELECT * from users  where login='tester'", User.class);
